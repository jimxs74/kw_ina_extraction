...
from utils.pke_data_structures import Candidate
from utils.pke_readers import PreprocessedReader
...
class LoadFile(object):
    ...
    def load_document(self, input):
        ...
        if isinstance(input, list) and all(isinstance(item, list) for item in input):
            ...
            raise TypeError('Cannot process input. It is not a list of list of tuple: {}'.format(type(input)))
